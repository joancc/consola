...
Consola.Level4 = function() {};

//setting game configuration and loading the assets for the loading screen
Consola.Level4.prototype = {
    preload: function() {
    ...
    create: function() {
        ...
        this.map = this.game.add.tilemap('level4');
		    ...
		    this.map.createFromObjects('ObjectEnemyLayer', 473, 'enemy', 0, true, false, this.enemies, Consola.EnemyLooper);
        ...
        //GRID
                //Width in tiles, 
        drawGrid(this.map.width, this.map.height, Consola.Constants.CELL_WIDTH, Consola.Constants.CELL_HEIGHT);
