...
Consola.Game = function() {};

//setting game configuration and loading the assets for the loading screen
Consola.Game.prototype = {
    preload: function() {
        this.moving = false;
    ...
    create: function() {
        ...
        //ENEMIES
        Consola.Game.enemies = [];
        // Consola.Game.enemies = game.add.group();
        // Consola.Game.enemies.add.existing(enemy);

        // enemy = new Consola.Enemy(this.game, 64, 64, 'enemy');
        // Consola.Game.enemies.push(enemy);
    ...
    update: function() {
        ...
        //Allow when cycle for execution of enemy turn
