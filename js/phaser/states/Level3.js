...
Consola.Level3 = function() {};

//setting game configuration and loading the assets for the loading screen
Consola.Level3.prototype = {
    preload: function() {
    ...
    create: function() {
        ...
        //ENEMIES
        Consola.Level3.enemies = [];
        // Consola.Level3.enemies = game.add.group();
        // Consola.Level3.enemies.add.existing(enemy);

        // enemy = new Consola.Enemy(this.game, 64, 64, 'enemy');
        // Consola.Level3.enemies.push(enemy);
